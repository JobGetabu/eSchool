...
{
    public partial class FrmFilterIncome : Form
    {
        public FrmFilterIncome()
        {
            InitializeComponent();
            Nullify();
        }
        ...
        private void FrmFilterIncome_Load(object sender, EventArgs e)
        {
        ...
        private void FrmFilterIncome_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (close == 1)
            {
                e.Cancel = false;
            ...
            //change term labels
            IncomeUI inui = IncomeUI.Instance;
            inui.lblT1.Text = "";
            inui.lblT2.Text = "";
            inui.lblT3.Text = "";
            e.Cancel = false;
